document.addEventListener('DOMContentLoaded', function() {
        ...
        if (formType === 'exponential') {
            fieldsHTML = `
                <div class="form-group">
                    ...
                    <div class="input-fields">
                        <input type="number" step="any" name="mod1" placeholder="Modulus" required>
                        <input type="number" step="any" name="arg1" placeholder="Argument" required>
                    </div>
                </div>
                <div class="form-group">
                    <label>Second number:</label>
                    <div class="input-fields">
                        <input type="number" step="any" name="mod2" placeholder="Modulus" required>
                        <input type="number" step="any" name="arg2" placeholder="Argument" required>
                    </div>
                </div>`;
            ...
            fieldsHTML = `
                <div class="form-group">
                    ...
                    <div class="input-fields">
                        <input type="number" step="any" name="mod1" placeholder="Modulus" required>
                        <input type="number" step="any" name="arg1angleA" placeholder="Angle (in degrees)" required>
                        <input type="number" step="any" name="arg1angleB" placeholder="Angle (in degrees)" required>
                    </div>
                </div>
                <div class="form-group">
                    <label>Second number:</label>
                    <div class="input-fields">
                        <input type="number" step="any" name="mod2" placeholder="Modulus" required>
                        <input type="number" step="any" name="arg2angleA" placeholder="Angle (in degrees)" required>
                        <input type="number" step="any" name="arg2angleB" placeholder="Angle (in degrees)" required>
                    </div>
                </div>`;
    ...
    document.getElementById('calculate').addEventListener('click', function() {
        ...
        if (!valid) {
            results.innerHTML = '<div id="error">Please enter valid values.</div>';
            return;
        }
            ...
            if (formType === 'exponential') {
                ...
                switch (op) {
                    case 'add':
                        ...
                        results.innerHTML += `<div class="result-item">Sum: ${formatResult(result)}</div>`;
                        break;
                    case 'subtract':
                        result = subtractExponentialComplex(mod1, arg1, mod2, arg2);
                        results.innerHTML += `<div class="result-item">Difference: ${formatResult(result)}</div>`;
                        break;
                    case 'multiply':
                        result = multiplyExponentialComplex(mod1, arg1, mod2, arg2);
                        results.innerHTML += `<div class="result-item">Product: ${formatResult(result)}</div>`;
                        break;
                    case 'divide':
                        result = divideExponentialComplex(mod1, arg1, mod2, arg2);
                        results.innerHTML += `<div class="result-item">Quotient: ${formatResult(result)}</div>`;
                        break;
                    default:
                        break;
                }
